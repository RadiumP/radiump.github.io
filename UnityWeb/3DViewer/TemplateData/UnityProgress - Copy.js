function UnityProgress (dom) {
	...
	logoImage.src = "/css/3DModelViewerTest/TemplateData/Logo." + splashStyle + ".png"; 
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "/css/3DModelViewerTest/TemplateData/ProgressFrame." + splashStyle + ".png"; 
	...
	progressBarImg.src = "/css/3DModelViewerTest/TemplateData/ProgressBar." + splashStyle + ".png"; 
